#ifndef __CNaviMeshRun_h__
#define __CNaviMeshRun_h__
...
class ENGINE_DLL CNaviMeshRun : public CMesh
{
private:
	explicit CNaviMeshRun(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CNaviMeshRun(const CNaviMeshRun& rhs);
	virtual ~CNaviMeshRun(void);
...
private:
	...
	_float					m_fHight;
public:
	static  CNaviMeshRun*		Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrNaviMeshName);
