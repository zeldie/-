...
Engine::CNaviMeshRun::CNaviMeshRun(LPDIRECT3DDEVICE9 pGraphicDev)
	: CMesh(pGraphicDev)
	, m_dwIndex(1000)
	, m_bIsLanding(false)
	, m_fHight(0.f)
...
Engine::CNaviMeshRun::CNaviMeshRun(const CNaviMeshRun& rhs)
	: CMesh(rhs)
...
Engine::CNaviMeshRun::~CNaviMeshRun()
{

}

HRESULT Engine::CNaviMeshRun::Ready_NaviMesh(wstring wstrNaviMeshName)
{
...
HRESULT CNaviMeshRun::Load_NaviMesh(wstring wstrNaviMeshName)
{
	WCHAR* StrPath = L"";
	...
	else if (wstrNaviMeshName == L"Mesh_Navi_Apostle1")
		StrPath = L"../../Data/Mesh/Mesh_Navi_Apostle1.dat";
...
_bool CNaviMeshRun::Check_Landing(_vec3 * pRayPos, _ulong dwIndex)
{
...
_bool CNaviMeshRun::Check_Index(_vec3 Target, _ulong dwIndex)
{
...
HRESULT Engine::CNaviMeshRun::Link_Cell(void)
{
...
CNaviMeshRun* Engine::CNaviMeshRun::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrNaviMeshName)
{
	CNaviMeshRun*	pInstance = new CNaviMeshRun(pGraphicDev);
...
CComponent* Engine::CNaviMeshRun::Clone()
{
	return new CNaviMeshRun(*this);
}

void Engine::CNaviMeshRun::Free()
{
	CMesh::Free();
...
_vec3 Engine::CNaviMeshRun::Move_OnNaviMesh(const _vec3* pTargetPos, const _vec3* pTargetDir, _ulong& pIndex, _bool bIsJump)
{
...
void CNaviMeshRun::Find_Index(_ulong& pIndex, _vec3* pRayPos)
{
	_float fNewDist = 0.f, fPrevDist = 10000.f;
	_ulong dwIndex = 0;
	_vec3 vVtx1, vVtx2, vVtx3;
...
_vec3 CNaviMeshRun::Move_OnCamNavi(const _vec3* pTargetPos, const _vec3* pTargetDir, _ulong& pIndex, _bool bIsJump)
{
	_vec3		vEndPos = *pTargetPos + *pTargetDir;
...
void Engine::CNaviMeshRun::Render_NaviMesh()
{
#ifdef _DEBUG
	for (auto& iter : m_vecCell)
		iter->Render_Cell();
...
void CNaviMeshRun::Find_PosY(_vec3* pRayPos, _ulong dwIndex, _vec3& vPosY)
{
	_float fNewDist = 0.f, fPrevDist = 10000.f;
	_vec3 vVtx1, vVtx2, vVtx3;
	_float fU = 0, fV = 0;
