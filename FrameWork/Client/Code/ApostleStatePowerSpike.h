...
class CApostleStatePowerSpike :
	public CApostleState
{

	CApostleStatePowerSpike();
	virtual ~CApostleStatePowerSpike();
...
public:
	static CApostleStatePowerSpike*	Create(Engine::CDynamicMesh* pMeshCom, Engine::CTransform* pTransformCom, CPlayerObserver* pPlayerObserver, BASE_INFO* pBaseInfo);
