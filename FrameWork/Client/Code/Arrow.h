...
class CArrow : public CStaticMeshObject
{
public:
	enum ARROW_TYPE
	{
...
private:
	...
	_float			m_fLifeTime;
public:
	static	CArrow*	Create(LPDIRECT3DDEVICE9 pGraphicDev, ARROW_TYPE eArrowType, _vec3* pPos, _vec3* pAngle, _float fStopPos, _vec3 vTargetPos, CONTROLTYPE eControlType);
	virtual void	Free();
};
