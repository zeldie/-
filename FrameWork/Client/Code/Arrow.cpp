...
void CArrow::Move(const _double& dTimeDelta)
{
...
HRESULT CArrow::Ready_GameObject(ARROW_TYPE eArrowType, _vec3 * pPos, _vec3* pAngle, _float fStopPos, _vec3 vTargetPos, CONTROLTYPE eControlType)
{
...
_int CArrow::Update_GameObject(const _double & dTimeDelta)
{
	if (m_bIsDead)
	{
		// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Ai %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
...
_int CArrow::LateUpdate_GameObject(const _double & dTimeDelta)
{
	if (m_bIsDead)
	{
		// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Ai %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
...
void CArrow::Render_Geometry(const _double & dTimeDelta)
{
...
HRESULT CArrow::Clone_Component(ARROW_TYPE eArrowType)
{
...
HRESULT CArrow::Setup_ShaderProps(LPD3DXEFFECT & pEffect, const _double& dTimeDelta)
{
...
CArrow * CArrow::Create(LPDIRECT3DDEVICE9 pGraphicDev, ARROW_TYPE eArrowType, _vec3 * pPos, _vec3* pAngle, _float fStopPos, _vec3 vTargetPos, CONTROLTYPE eControlType)
{
