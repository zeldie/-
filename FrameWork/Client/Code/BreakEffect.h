#pragma once
#ifndef __CBreakEffect_H__
#define __CBreakEffect_H__

#include "BaseEffect.h"
#include "RcTex.h"
#include "Texture.h"

class CBreakEffect : public CBaseEffect
{
private:
...
public:
	static	CBreakEffect*	Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3* pPos, _vec3* pAngle = &_vec3(0.f, 0.f, 0.f), BASE_INFO* pBaseInfo = nullptr);
	virtual void	Free();
