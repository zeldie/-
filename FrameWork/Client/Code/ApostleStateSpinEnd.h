...
class CApostleStateSpinEnd :
	public CApostleState
{

	CApostleStateSpinEnd();
	virtual ~CApostleStateSpinEnd();
...
public:
	static CApostleStateSpinEnd*	Create(Engine::CDynamicMesh* pMeshCom, Engine::CTransform* pTransformCom, CPlayerObserver* pPlayerObserver, BASE_INFO* pBaseInfo);
