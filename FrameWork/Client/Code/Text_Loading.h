...
#ifndef __CText_Loading_h__
#define __CText_Loading_h__

#include "NormalObject.h"

class CText_Loading : public CNormalObject
{
public:
	explicit CText_Loading(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CText_Loading();
...
public:
	static CText_Loading*		Create(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual void			Free();
};
