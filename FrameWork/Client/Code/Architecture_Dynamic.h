...
class CArchitecture_Dynamic : public CDynamicMeshObject
{
private:
	explicit CArchitecture_Dynamic(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CArchitecture_Dynamic();
...
public:
	static	CArchitecture_Dynamic*	Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrObjectKey, _vec3* pPos, _vec3* pAngle, _vec3* pScale);
	virtual void			Free();
};
