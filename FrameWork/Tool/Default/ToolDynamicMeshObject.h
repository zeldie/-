...
class CToolDynamicMeshObject : public CToolGameObject
{
public:
	explicit CToolDynamicMeshObject(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CToolDynamicMeshObject();
...
public:
	static CToolDynamicMeshObject* Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrObjectKey, _vec3* pPos = &_vec3(0.f,0.f, 0.f), _vec3* pAngle = &_vec3(0.f, 0.f, 0.f), _vec3* pScale = &_vec3(1.f, 1.f, 1.f));
protected:
